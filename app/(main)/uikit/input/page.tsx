"use client";
import type { Demo, Page } from "@/types/index";
import {
    AutoComplete,
...
const InputDemo: Page = () => {
    ...
    const [multiselectValue, setMultiselectValue] = useState<InputValue[]>([]);
    const [toggleValue, setToggleValue] = useState(false);
    const [selectButtonValue1, setSelectButtonValue1] = useState<InputValue | null>(null);
